...
public class DataProviderEndpointsConsts {
    ...
    private static final String API_TRANSIENT_SESSION_ENDPOINT = "/transient-session/{0}";
    private static final String API_PERSISTENT_SESSION_ENDPOINT = "/persistent-session/{0}";
