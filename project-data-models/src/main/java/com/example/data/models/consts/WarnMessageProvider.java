...
public class WarnMessageProvider {
    ...
    private static final String NOT_FOUND_USER_WITH_INPUT_EMAIL = "Зарегистрированного юзера с email {0} не найдено, " +
            "введите повторно корректный адрес электронной почты или пройдите зарегистрируйтесь в боте {1}.";
    ...
    public static String getNotValidEmailAddress(String emailAddress, String registeredCommandText) {
        return MessageFormat.format(NOT_VALID_EMAIL_ADDRESS, emailAddress, registeredCommandText);
    }
